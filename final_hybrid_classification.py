...
# Switched to the newly trained ResNet18 640x640 version
MODEL_TYPE = 'resnet18'  
WEIGHTS_PATH = 'resnet18_checkpoint/best_resnet18_model.pth' 
...
def get_target_layers(model, model_type):
    ...
    if model_type == 'resnet18':
        # Apply the lesson from EigenCAM: use layer3 instead of layer4 for better spatial resolution!
        ...
        try:
            ...
            print("⚠️ Cannot find the corresponding layer for Custom CNN, please specify manually.")
            return None
...
def main():
    ...
    while cap.isOpened():
        ...
        if top >= 0 and left >= 0 and top+CROP_SIZE <= height and left+CROP_SIZE <= width:
            ...
            # Draw a yellow box to clearly indicate the model's current "large visual area"
